...
## Download
### *See [Maven Central](https://central.sonatype.com/artifact/io.github.rukins/gkeepapi/1.2.4) or [Maven repository](https://mvnrepository.com/artifact/io.github.rukins/gkeepapi)*
#### Maven
```xml
<dependency>
